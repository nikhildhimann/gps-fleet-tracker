...
export function AlertManagementModal({ isOpen, onClose }: AlertManagementModalProps) {
  ...
  return (
    <>
      ...
      >
        <div 
          className="w-full h-full max-w-7xl max-h-[90vh] bg-white rounded-lg shadow-2xl flex flex-col overflow-hidden"
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gray-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => console.log("Create alert functionality")}
